<?php include ("inc/header.php") ;?>
	...
	$pr =new prodect;
	$prodss= $pr->selectedWhere("name LIKE '%$keyWord%' ","id,name,price,img");
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src=" <?=URL;?>assts/images/shop_background.jpg"></div>
